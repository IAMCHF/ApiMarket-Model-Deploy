...
# -*- coding: utf-8 -*-
# ============================================================================
# __MODEL_ID__ 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python __TEST_NAME__.py                  # 默认 localhost:8080
#   内网部署:  python __TEST_NAME__.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="__MODEL_ID__ 服务测试")
