...
# -*- coding: utf-8 -*-
# ============================================================================
# Intellindust/DEIMv2_DINOv3_X_COCO 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-Intellindust-DEIMv2_DINOv3_X_COCO.py            # 默认 localhost:8080
#   内网部署:  python test-Intellindust-DEIMv2_DINOv3_X_COCO.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Intellindust/DEIMv2_DINOv3_X_COCO 服务测试")
