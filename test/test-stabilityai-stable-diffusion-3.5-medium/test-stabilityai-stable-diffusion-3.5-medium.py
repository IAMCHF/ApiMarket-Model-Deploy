...
# -*- coding: utf-8 -*-
# ============================================================================
# stabilityai/stable-diffusion-3.5-medium 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-stabilityai-stable-diffusion-3.5-medium.py            # 默认 localhost:8080
#   内网部署:  python test-stabilityai-stable-diffusion-3.5-medium.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="stabilityai/stable-diffusion-3.5-medium 服务测试")
