...
#
# 用法：
#   本机验证:  python test-CohereLabs-cohere-transcribe-03-2026.py                  # 默认 localhost:8080
#   内网部署:  python test-CohereLabs-cohere-transcribe-03-2026.py --host 10.0.62.60 --port <映射端口>
#
