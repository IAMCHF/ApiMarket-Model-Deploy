...
# -*- coding: utf-8 -*-
# ============================================================================
# Qwen/Qwen3-Embedding-0.6B 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-Qwen-Qwen3-Embedding-0.6B.py                  # 默认 localhost:8080
#   内网部署:  python test-Qwen-Qwen3-Embedding-0.6B.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Qwen/Qwen3-Embedding-0.6B 服务测试")
