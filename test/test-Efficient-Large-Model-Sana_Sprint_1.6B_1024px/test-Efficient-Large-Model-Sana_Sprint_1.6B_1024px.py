...
# -*- coding: utf-8 -*-
# ============================================================================
# Efficient-Large-Model/Sana_Sprint_1.6B_1024px 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-Efficient-Large-Model-Sana_Sprint_1.6B_1024px.py            # 默认 localhost:8080
#   内网部署:  python test-Efficient-Large-Model-Sana_Sprint_1.6B_1024px.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'prompt': 'a cute cat, high quality'}


def main() -> int:
    parser = argparse.ArgumentParser(description="Efficient-Large-Model/Sana_Sprint_1.6B_1024px 服务测试")
