...
# -*- coding: utf-8 -*-
# ============================================================================
# openai/privacy-filter 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-openai-privacy-filter.py            # 默认 localhost:8080
#   内网部署:  python test-openai-privacy-filter.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'text': '我的银行卡号是6222000012345678'}


def main() -> int:
    parser = argparse.ArgumentParser(description="openai/privacy-filter 服务测试")
