...
# -*- coding: utf-8 -*-
# ============================================================================
# canopylabs/orpheus-3b-0.1-ft 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-canopylabs-orpheus-3b-0.1-ft.py                  # 默认 localhost:8080
#   内网部署:  python test-canopylabs-orpheus-3b-0.1-ft.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="canopylabs/orpheus-3b-0.1-ft 服务测试")
