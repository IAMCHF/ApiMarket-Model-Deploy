...
# -*- coding: utf-8 -*-
# ============================================================================
# cisco-ai/Antares-1B 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-cisco-ai-Antares-1B.py                  # 默认 localhost:8080
#   内网部署:  python test-cisco-ai-Antares-1B.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'code': _load_text('code.txt')}


def main() -> int:
    parser = argparse.ArgumentParser(description="cisco-ai/Antares-1B 服务测试")
