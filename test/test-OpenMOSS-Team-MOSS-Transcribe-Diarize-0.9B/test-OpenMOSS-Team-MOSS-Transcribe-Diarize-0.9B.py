...
# -*- coding: utf-8 -*-
# ============================================================================
# OpenMOSS-Team/MOSS-Transcribe-Diarize-0.9B 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-OpenMOSS-Team-MOSS-Transcribe-Diarize-0.9B.py            # 默认 localhost:8080
#   内网部署:  python test-OpenMOSS-Team-MOSS-Transcribe-Diarize-0.9B.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'audio': _gen_audio(duration=3.0)}


def main() -> int:
    parser = argparse.ArgumentParser(description="OpenMOSS-Team/MOSS-Transcribe-Diarize-0.9B 服务测试")
