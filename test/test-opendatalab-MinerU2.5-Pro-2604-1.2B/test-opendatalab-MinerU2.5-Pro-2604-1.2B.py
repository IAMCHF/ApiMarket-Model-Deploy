...
# -*- coding: utf-8 -*-
# ============================================================================
# opendatalab/MinerU2.5-Pro-2604-1.2B 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-opendatalab-MinerU2.5-Pro-2604-1.2B.py            # 默认 localhost:8080
#   内网部署:  python test-opendatalab-MinerU2.5-Pro-2604-1.2B.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'image': _gen_image()}


def main() -> int:
    parser = argparse.ArgumentParser(description="opendatalab/MinerU2.5-Pro-2604-1.2B 服务测试")
