...
# -*- coding: utf-8 -*-
# ============================================================================
# jinaai/jina-embeddings-v5-omni-small 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-jinaai-jina-embeddings-v5-omni-small.py                  # 默认 localhost:8080
#   内网部署:  python test-jinaai-jina-embeddings-v5-omni-small.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="jinaai/jina-embeddings-v5-omni-small 服务测试")
