...
# -*- coding: utf-8 -*-
# ============================================================================
# deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-deepseek-ai-DeepSeek-Coder-V2-Lite-Instruct.py                  # 默认 localhost:8080
#   内网部署:  python test-deepseek-ai-DeepSeek-Coder-V2-Lite-Instruct.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'prompt': _load_text('prompt_code.txt')}


def main() -> int:
    parser = argparse.ArgumentParser(description="deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct 服务测试")
