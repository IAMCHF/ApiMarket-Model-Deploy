...
# -*- coding: utf-8 -*-
# ============================================================================
# Qualcomm-AI-Research/mobilewan 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-Qualcomm-AI-Research-mobilewan.py            # 默认 localhost:8080
#   内网部署:  python test-Qualcomm-AI-Research-mobilewan.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'prompt': 'a boat sailing on the sea'}


def main() -> int:
    parser = argparse.ArgumentParser(description="Qualcomm-AI-Research/mobilewan 服务测试")
