...
# -*- coding: utf-8 -*-
# ============================================================================
# lightonai/LightOnOCR-2-1B 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-lightonai-LightOnOCR-2-1B.py            # 默认 localhost:8080
#   内网部署:  python test-lightonai-LightOnOCR-2-1B.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="lightonai/LightOnOCR-2-1B 服务测试")
