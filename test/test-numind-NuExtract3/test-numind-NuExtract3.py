...
# -*- coding: utf-8 -*-
# ============================================================================
# numind/NuExtract3 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-numind-NuExtract3.py                  # 默认 localhost:8080
#   内网部署:  python test-numind-NuExtract3.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'document': _load_text('document.txt'), 'schema': _load_json('schema.json')}


def main() -> int:
    parser = argparse.ArgumentParser(description="numind/NuExtract3 服务测试")
