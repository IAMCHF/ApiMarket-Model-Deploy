...
# -*- coding: utf-8 -*-
# ============================================================================
# sentence-transformers/all-MiniLM-L6-v2 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-sentence-transformers-all-MiniLM-L6-v2.py                  # 默认 localhost:8080
#   内网部署:  python test-sentence-transformers-all-MiniLM-L6-v2.py --host 10.0.62.60 --port <映射端口>
#
...
def main() -> int:
    parser = argparse.ArgumentParser(description="sentence-transformers/all-MiniLM-L6-v2 服务测试")
