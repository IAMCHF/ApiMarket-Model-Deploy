...
# -*- coding: utf-8 -*-
# ============================================================================
# IDEA-Research/grounding-dino-1.5-pro 服务测试脚本（自动生成，可自行扩展测试数据）
#
# 用法：
#   本机验证:  python test-IDEA-Research-grounding-dino-1.5-pro.py                  # 默认 localhost:8080
#   内网部署:  python test-IDEA-Research-grounding-dino-1.5-pro.py --host 10.0.62.60 --port <映射端口>
#
...
def gen_inputs():
    ...
    return {'image': _load_b64('image.png'), 'prompt': _load_text('prompt.txt')}


def main() -> int:
    parser = argparse.ArgumentParser(description="IDEA-Research/grounding-dino-1.5-pro 服务测试")
